...
/**
 * BQNonCashInventoryHandlingRequestOutputModel
 */
public class BQNonCashInventoryHandlingRequestOutputModel   {
  private String nonCashInventoryHandlingRequestActionTaskReference = null;

  private Object nonCashInventoryHandlingRequestActionTaskRecord = null;

  private String nonCashInventoryHandlingRequestRecordReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Non Cash Inventory Handling instance request service call 
   * @return nonCashInventoryHandlingRequestActionTaskReference
  **/

  public String getNonCashInventoryHandlingRequestActionTaskReference() {
    return nonCashInventoryHandlingRequestActionTaskReference;
  }

  public void setNonCashInventoryHandlingRequestActionTaskReference(String nonCashInventoryHandlingRequestActionTaskReference) {
    this.nonCashInventoryHandlingRequestActionTaskReference = nonCashInventoryHandlingRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return nonCashInventoryHandlingRequestActionTaskRecord
  **/

  public Object getNonCashInventoryHandlingRequestActionTaskRecord() {
    return nonCashInventoryHandlingRequestActionTaskRecord;
  }

  public void setNonCashInventoryHandlingRequestActionTaskRecord(Object nonCashInventoryHandlingRequestActionTaskRecord) {
    this.nonCashInventoryHandlingRequestActionTaskRecord = nonCashInventoryHandlingRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Non Cash Inventory Handling service request record 
   * @return nonCashInventoryHandlingRequestRecordReference
  **/

  public String getNonCashInventoryHandlingRequestRecordReference() {
    return nonCashInventoryHandlingRequestRecordReference;
  }

  public void setNonCashInventoryHandlingRequestRecordReference(String nonCashInventoryHandlingRequestRecordReference) {
    this.nonCashInventoryHandlingRequestRecordReference = nonCashInventoryHandlingRequestRecordReference;
  }
