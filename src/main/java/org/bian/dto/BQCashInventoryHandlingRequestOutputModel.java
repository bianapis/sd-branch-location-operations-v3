...
/**
 * BQCashInventoryHandlingRequestOutputModel
 */
public class BQCashInventoryHandlingRequestOutputModel   {
  private String cashInventoryHandlingRequestActionTaskReference = null;

  private Object cashInventoryHandlingRequestActionTaskRecord = null;

  private String cashInventoryHandlingRequestRecordReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Cash Inventory Handling instance request service call 
   * @return cashInventoryHandlingRequestActionTaskReference
  **/

  public String getCashInventoryHandlingRequestActionTaskReference() {
    return cashInventoryHandlingRequestActionTaskReference;
  }

  public void setCashInventoryHandlingRequestActionTaskReference(String cashInventoryHandlingRequestActionTaskReference) {
    this.cashInventoryHandlingRequestActionTaskReference = cashInventoryHandlingRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return cashInventoryHandlingRequestActionTaskRecord
  **/

  public Object getCashInventoryHandlingRequestActionTaskRecord() {
    return cashInventoryHandlingRequestActionTaskRecord;
  }

  public void setCashInventoryHandlingRequestActionTaskRecord(Object cashInventoryHandlingRequestActionTaskRecord) {
    this.cashInventoryHandlingRequestActionTaskRecord = cashInventoryHandlingRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Cash Inventory Handling service request record 
   * @return cashInventoryHandlingRequestRecordReference
  **/

  public String getCashInventoryHandlingRequestRecordReference() {
    return cashInventoryHandlingRequestRecordReference;
  }

  public void setCashInventoryHandlingRequestRecordReference(String cashInventoryHandlingRequestRecordReference) {
    this.cashInventoryHandlingRequestRecordReference = cashInventoryHandlingRequestRecordReference;
  }
